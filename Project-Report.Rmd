...
> But note that R^2 doesn't mean the same thing for glms, and it's not really accurate, so... you should be able to find a better way to analyze the data...
...
> I don't care how much data you have, fitting a full interaction model is too much. Be strategic. Use stepwise regression... or just plot your data and add terms related to what you see!
...
> Or you could just say "The $R^2$ from the glm was `r rsq`"
